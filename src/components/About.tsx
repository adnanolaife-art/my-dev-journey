      ...
      <div className="container-tight">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            ...
            engineering, clean code, and user-centered design. I enjoy the
            challenge of learning new technologies and applying them to build
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          <div className="rounded-2xl border border-border bg-card p-6 sm:p-8">
            ...
            <div className="mt-4 space-y-4 text-muted-foreground">
              <p>
                I started coding by building small projects that solved problems
                I cared about. That curiosity turned into a career path, and today
                I focus on writing maintainable, accessible web applications.
              </p>
              <p>
                Whether it's crafting a smooth user interface, debugging a tricky
                state issue, or learning a new framework, I bring enthusiasm and
